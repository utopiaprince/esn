...
static void camera_recv_data_handle(uint8_t *pdata, uint8_t len)
{
...
void esn_gain_init(void)
{
    ...
    camera_init(CAM_PORT, 115200, esn_gain_queue,
                camera_recv_data_handle);
}
